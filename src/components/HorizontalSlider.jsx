...
const HorizontalSlider = ({ children }) => {
  return (
    <div
      className="mx-auto overflow-x-scroll px-4 py-1 overflow-y-hidden scrollbar-hide scroll-smooth scrollbar-thin scrollbar-thumb-yellow-300  dark:scrollbar-thumb-yellow-200 dark:scrollbar-track-black  
